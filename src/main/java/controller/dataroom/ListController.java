...
public class ListController extends HttpServlet {
	 ...
	 * 
	 * ※GET 및 POST방식을 구분하지 않고 요청을 받으려면 service()를 오버라이딩 하거나 혹은 위의 두 메소드 즉 doGet()
	 * ,doPost()를 오버라이딩해서 한쪽 메소드에서 받은 요청을 다른 쪽으로 전달하면 된다. 예]
	 * 
	 ...
	 * resp) throws ServletException, IOException { //여기서 컨트롤러(서블릿)이 할일을 구현 }
	 */
	@Override
